...
public abstract class CameraActivity extends AppCompatActivity implements View.OnClickListener,SurfaceHolder.Callback {
    private SurfaceView mSurfaceView;
    private ImageView mImageView;
    private SurfaceHolder mSurfaceHolder;
    private ImageView shutter;
    private Camera mCamera = null;
    private boolean mPreviewRnning;
        ...
        if(mPreviewRnning){
            ...
            mCamera.autoFocus(new Camera.AutoFocusCallback() {
                ...
                public void onAutoFocus(boolean success, Camera camera) {
                    mCamera.takePicture(mShutterCallnack,null,mPictureCallback);
                }
            });
        }
    }
    ...
    Camera.ShutterCallback mShutterCallnack=new Camera.ShutterCallback() {
        @Override
